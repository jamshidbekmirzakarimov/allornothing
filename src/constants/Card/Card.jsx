...
const Card = ({action, image, title, price, delprice, color}) => {
  return (
    <>
      <li className="w-[24%] min-h-[461px]">
        <div className="w-full bg-white rounded-[12px] flex items-center justify-center h-[380px] relative overflow-hidden">
          <div className={`absolute top-0 left-0 py-[7px] px-[15px] text-white font-normal text-[12px] rounded-tl-[12px] rounded-br-[12px] bg-[${color}]`}>
            {action}
          </div>
          <img className="absolute top-[17px] right-[16px]" src={Like} alt="" />
          <img src={image} alt="" />
        </div>
